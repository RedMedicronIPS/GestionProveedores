...
<%
    ...
    if(!"Delete".equals(accion)) {
        ...
        if(pais != null && !pais.isEmpty()) tercero.setTercero_pais(pais);
        if(depto != null && !depto.isEmpty()) tercero.setTercero_departamento(depto);
        if(ciudad != null && !ciudad.isEmpty()) tercero.setTercero_ciudad(ciudad);
